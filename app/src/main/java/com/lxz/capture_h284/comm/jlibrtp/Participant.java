 ...
 */
package com.lxz.capture_h284.comm.jlibrtp;
...
public class Participant {
	...
	public String toString() {
		return "Participant{" +
				...
				", rtpReceivedFromAddress=" + rtpReceivedFromAddress +
				", rtcpReceivedFromAddress=" + rtcpReceivedFromAddress +
				", ssrc=" + ssrc +
				", cname='" + cname + '\'' +
				", name='" + name + '\'' +
				", email='" + email + '\'' +
				...
				", note='" + note + '\'' +
				", priv='" + priv + '\'' +
				", firstSeqNumber=" + firstSeqNumber +
				", lastSeqNumber=" + lastSeqNumber +
				", seqRollOverCount=" + seqRollOverCount +
				", receivedPkts=" + receivedPkts +
				", receivedOctets=" + receivedOctets +
				", receivedSinceLastSR=" + receivedSinceLastSR +
				", lastSRRseqNumber=" + lastSRRseqNumber +
				", interArrivalJitter=" + interArrivalJitter +
				", lastRtpTimestamp=" + lastRtpTimestamp +
				", timeStampLSR=" + timeStampLSR +
				", timeReceivedLSR=" + timeReceivedLSR +
				", ntpGradient=" + ntpGradient +
				", ntpOffset=" + ntpOffset +
				", lastNtpTs1=" + lastNtpTs1 +
				", lastNtpTs2=" + lastNtpTs2 +
				", lastSRRtpTs=" + lastSRRtpTs +
				", timestampBYE=" + timestampBYE +
				", pktBuffer=" + pktBuffer +
				", lastRtpPkt=" + lastRtpPkt +
				", lastRtcpPkt=" + lastRtcpPkt +
				", addedByApp=" + addedByApp +
				", lastRtcpRRPkt=" + lastRtcpRRPkt +
				", secondLastRtcpRRPkt=" + secondLastRtcpRRPkt +
				'}';
	}
}
