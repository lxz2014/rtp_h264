...
public class MediaCodecVideoDecoder {
    ...
    private static final String[] supportedH264HwCodecPrefixes =
            {"OMX.qcom.", "OMX.Intel.", "OMX.IMG.", "OMX.allwinner."};
    ...
    private boolean initDecode(
        ...
        try {
            ...
            Logging.e(TAG, "initDecode failed" + e.getLocalizedMessage());
            return false;
        }
    }
        ...
        Runnable runMediaCodecRelease = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Logging.e(TAG, "Media decoder release failed" + e.getLocalizedMessage());
                }
    ...
    private int dequeueInputBuffer() {
        ...
        try {
            ...
            Logging.e(TAG, "dequeueIntputBuffer failed" + e.getLocalizedMessage());
            return -2;
        }
    }
    ...
    private boolean queueInputBuffer(int inputBufferIndex, int size, long presentationTimeStamUs,
        ...
        try {
            ...
            Logging.e(TAG, "decode failed" + e.getLocalizedMessage());
            return false;
        }
    }
  ...
  */
    ...
    private DecodedTextureBuffer dequeueTextureBuffer(int dequeueTimeoutMs) {
        ...
        DecodedTextureBuffer renderedBuffer = null;
        if (renderedBuffer != null) {
            MaybeRenderDecodedTextureBuffer();
